(() => {
    ...
    function createResult (){
        // const pStrings = [
        //     `Your guess: ${sliderValues[0]}, ${sliderValues[1]}, ${sliderValues[2]}`,
        //     `Actual values: ${currentRGB[0]}, ${currentRGB[1]}, ${currentRGB[2]}`,
        //     `Score: ${roundScores[currentRound-1]}`
        // ];
        // const newCard = document.createElement('div');
        // const newHeader = document.createElement('h3');
        // newHeader.textContent = `Round ${currentRound}`;
        // newCard.appendChild(newHeader);
        // for(let i=0; i<pStrings.length; i++){
        //     const newP = document.createElement('p');
        //     newP.textContent = pStrings[i];
